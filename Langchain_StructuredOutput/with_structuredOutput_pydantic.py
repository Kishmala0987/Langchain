...
class Review(BaseModel):
    ...
    sentinent: Literal["pos", "neg"] = Field(description = "Return sentiment of the review either negative, positive or neutral")
    ...
    name: Optional[str] = Field(description = "Write the name of the Reviewer not of the product")
